...
function About() {
  return (
    <div className="flex flex-col md:flex-row items-center justify-center py-12">
      <img src="public/assets/1721696873862.jpg" alt="Profile" className="rounded-full w-[700px] h-[700px] object-cover mb-6 md:mb-0 md:mr-6" />
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg mb-10 text-2xl text-opacity-10">
        <p>
